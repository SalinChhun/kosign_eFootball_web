...
import homeIcon from '@/public/asset/icon/home-icon.svg';
        ...
        <nav className="navbar">
            ...
            <ul className="navbar-menu">
                <li className="navbar-item">
                    <Link href="/scores" className={pathname.startsWith('/scores') ? 'cur_act' : ''}>
                ...
                <li className="navbar-item">
                    <Link href="/fixtures" className={pathname.startsWith('/fixtures') ? 'cur_act' : ''}>Fixtures</Link>
                </li>
                <li className="navbar-item">
                    <Link href="/tables" className={pathname.startsWith('/tables') ? 'cur_act' : ''}>
                ...
                <li className="navbar-item">
                    <Link href="/teams" className={pathname.startsWith('/teams') ? 'cur_act' : ''}>
                        <svg className="icon flat-color ks_img svg-icon" width="800px" height="800px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg"
            ...
            {isMenuOpen && (
                <div className={`mobile-menu ${isMenuOpen ? 'open' : ''}`}>
                    <ul>
                        ...
                        {/* Close Button */}
                        <li><Link href="/scores" onClick={closeMenu}>Home</Link></li>
                        <li><Link href="/fixtures" onClick={closeMenu}>Fixtures</Link></li>
                        <li><Link href="/tables" onClick={closeMenu}>Tables</Link></li>
                        <li><Link href="/teams" onClick={closeMenu}>Teams</Link></li>
                    </ul>
                </div>
            )}
        </nav>
